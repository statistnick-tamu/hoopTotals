...
more pieces of information: how much time is remaining, how many points are currently scored,
and a user definied threshold (this could be a betting line, or a prior expected score).
...
This is great, but we're still making a general assumption around how much a certain teams score.
...
and it will calculate the first two parameters to pass back in to the other functions.

Included are data from Texas A&M and Iowa State's Men's Basketball teams.
